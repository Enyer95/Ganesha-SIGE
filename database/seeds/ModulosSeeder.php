...
class ModulosSeeder extends Seeder
{
      ...
      public function run()
    {
        $modulos = array(
            ...
            array('nom_mod' => 'checkprivatepass.usuario','created_at'=>Carbon::now(),'updated_at'=>Carbon::now() ),
            array('nom_mod' => 'checkpublicpass.usuario','created_at'=>Carbon::now(),'updated_at'=>Carbon::now() ),
