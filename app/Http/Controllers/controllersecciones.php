...
class controllersecciones extends Controller
{
      ...
      public function mostrar()
    {
        ...
        //Creo una variable la cual Me trae toda la informacion que contiene la base de datos
        return view('Secciones/G_Secciones')->with(['sec' => $sec,'seccuenta' => $seccuenta,'sec2' => $sec2, 'uni_crr' => $uni_crr,'cuentauc' => $cuentauc, 'master' => $master, 'status' => ModelSeccion::max_secc(ModelPnf::MaxSec())]);
