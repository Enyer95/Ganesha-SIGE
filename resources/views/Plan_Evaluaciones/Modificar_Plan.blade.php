	...
	@if(isset($instrumentos))
		@foreach($uni_crr as $uc)
					<div class="modal fade" data-backdrop=”static” data-keyboard=”false” id="ModificarPlan" role="dialog">
				        ...
				        <!--Hidenssss-->
								    <form name="fo" method="POST" action="{{ url('/modificarplanevaluaciones/'.$id_plan) }}">
				                    	{{ csrf_field() }}
...
$(window).load(function() { 
	...
	@foreach($evaluaciones as $eva)
	    ...
	    var fila='<tr id="xD'+ iCnt +'" ><td style="width: 40px;">{{ $eva->unidad }}</td>'+
		    		'<td style="width: 40px;"><center><button type="button" name="Eliminar" id="'+iCnt+'" onclick="eliminar(this)" class="btn btn-danger btn-xs" disabled><img src="{{ url('/img/iconos/16x16/cancel.png') }}"></button></center></td>'+
		    		'<td style="width: 40px;"><center><button type="button" name="Rezagada" id="'+iCnt+'" onclick="rezagar(this)" class="btn btn-warning btn-xs reza'+iCnt+'" disabled><img src="{{ url('/img/iconos/16x16/check.png') }}"></button><input class="hide" type="text" name="rezaga[]" id="Rezagada'+iCnt+'" value="0"></center></td>'+
		...
		@else
		    		...
		    		'<td style="width: 40px;"><center><button type="button" name="Eliminar" id="'+iCnt+'" onclick="eliminar(this)" class="btn btn-danger btn-xs"><img src="{{ url('/img/iconos/16x16/cancel.png') }}"></button></center></td>'+
		    		'<td style="width: 40px;"><center><button type="button" name="Rezagada" id="'+iCnt+'" onclick="rezagar(this)" class="btn btn-warning btn-xs"><img src="{{ url('/img/iconos/16x16/check.png') }}"></button></center><input class="hide" type="text" name="rezaga[]" id="Rezagada'+iCnt+'" value="0"></td>'+
 ...
 //lo tranformo a numerico
    ...
    //creo una nueva fila
	    var fila='<tr id="xD'+ iCnt +'" ><td style="width: 40px;"><input type="text" name="unidad[]" id="'+iCnt+'" size="2"  maxlength="2" minlength="1" onKeyPress="return soloNumeros(event)" required autofocus></td>'+
	    		'<td style="width: 40px;"><center><button type="button" name="Eliminar" id="'+iCnt+'" onclick="eliminar(this)" class="btn btn-danger btn-xs"><img src="{{ url('/img/iconos/16x16/cancel.png') }}"></button></center></td>'+
	    		'<td style="width: 40px;"><center><button type="button" name="Rezagada" id="reza'+iCnt+'" onclick="rezagar(this)" class="btn btn-warning btn-xs" disabled><img src="{{ url('/img/iconos/16x16/check.png') }}" ></button></center></td>'+
