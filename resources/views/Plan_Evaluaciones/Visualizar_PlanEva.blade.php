				...
				@foreach($master as $Tpuente)
					...
					<section class="content-header">
				      <ol class="breadcrumb">
				        ...
				        <li><a href="{{ url('/Plan_Evaluaciones/Gestion_master') }}"><i class="fa fa-dashboard"></i> Gestion Plan Maestro</a></li>
...
<br>
					<div align="right">
						<a target="_blank" href="{{ url('/Plan_Evaluaciones/imprimirMaster/'.$cod_unidad) }}"> 
							<button type="button" class="btn btn-primary" >
	               				<img src="{{ url('/img/iconos/16x16/print.png') }}">
							</button>
						</a> 
					</div>
				@endforeach	
