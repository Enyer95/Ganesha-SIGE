                        ...
                        <div class="box-body">
                            ...
                            <div class="table-responsive">
                                <table class="table no-margin">
                                   ...
                                   <form role="form" method="POST" action="{{ url('/transcribir/notas') }}">
  									{{ csrf_field() }}
                                                ...
                                                @if(isset($evas))
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @if($eva->corte == 'ASIGNADA')
                                                            <img  style="display:auto;width: 100%; border: 0;max-width: 25px; padding: 0px;" src="{{ url('/img/iconos/16x16/download2.png') }}"/> Disponible
                                                            @endif

                                                            @if($eva->corte == 'TRANSCRITA')
                                                            <img style="display:auto;width: 100%; border: 0;max-width: 25px; padding: 0px;" src="{{ url('/img/iconos/16x16/exclamation-mark.png') }}" width="10" height="10"/> Transcrita
                                                            @endif

                                                            @if($eva->corte == 'SIN ASIGNAR')
                                                            <img style="display:auto;width: 100%; border: 0;max-width: 25px; padding: 0px;" src="{{ url('/img/iconos/16x16/advertencia.png') }}" width="10" height="10"/> SIN ASGINAR
                                                            @endif
                                                        </td>
                                                        <td>{{ $eva->unidad}}</td>
