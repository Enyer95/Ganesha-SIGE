                                                ...
                                                @if(isset($evas))
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <td>
                                                             ...
                                                             <div class="tools">                <a href="{{ url('/controllernotas/'.$eva->id_eva.'/'.$pu->id_uc_sec) }}">
                                                              <button title="Verificar" type='button' class='btn btn-primary btn-xs'>
                                                                <img src="{{ url('/img/iconos/16x16/checkbox.png') }}">
                                                              </button>                       
                                                            </a>      
                                                        </td>
                                                        <td>
                                                             ...
                                                             <div class="tools">      <a href="{{ url('/controllernotas/correo/'.$eva->id_eva.'/'.$pu->id_uc_sec) }}">
                                                              <button title="Publicar Notas" type='button' class='btn btn-warning btn-xs'>
                                                                <img src="{{ url('/img/iconos/16x16/mail.png') }}">
                                                              </button>
