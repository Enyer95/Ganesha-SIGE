...
<div class="modal fade" id="ModificaSec_{{$secc->cod_sec}}" role="dialog">
    ...
    <i class="fa fa-question quest" data-toggle="tooltip"  data-html="true" data-placement="bottom" title="Modifique los datos de la seccion actual<br>-Si las unidades curriculares para la seccion cambia, solo precione la 'x' en la unidad curricular a eliminar"></i>
