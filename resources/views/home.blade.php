		            ...
		            <!-- /.box-header -->
			            <div class="box-body table-responsive">
			              	<table class="table table-bordered">
					              	...
					              	@foreach($Planes as $plan)
						                ...
						                <tr>
						                    ...
						                    @if($plan['status']=='FAIL')
								                ...
								                <td>
								                	<span class="badge bg-red">{{$plan['porcentaje']}}%</span>
								                </td>
									        @else
					        	...
					        	@else
							    	<center>
								    	<h2>Aun no posee ningún Plan Maestro/Asignado</h2>
								        <img style="display:auto;width: 100%; border: 0;max-width: 280px;max-height:280px; padding: 0px;" src="{{ url('/img/elefante.jpg') }}" width="10" height="10">
							        </center>
			                	@endif
			            	</table>
			        	</div>{{--FIN TABLA--}}
