                        ...
                        <div class="card-content">
                            ...
                            <section class="content-header">
                              <ol class="breadcrumb">
                                ...
                                <li>
                                    <a href="{{ url('/Usuario/G_usu') }}"><i class="fa fa-dashboard"></i>
                                        Gestion de Usuarios
                                    </a>
                                </li>
                                <li class="active">
                            ...
                            <form class="form-horizontal" role="form" method="POST" action="{{ url('/Usuario/crear') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
