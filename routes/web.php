...
Route::group(['middleware'=>'permisos'],function(){
	...
	//Gestion usuarios
		...
		Route::post('controllerusers/validarpassprivate', 'controllerusers@privatepass')->name('checkprivatepass.usuario');
		// Route::post('controllerusers/validarpasspublic', 'controllerusers@publicpass')->name('checkpublicpass.usuario');
...
//RUTA PLANES
	...
	//PERFIL
		...
		Route::get('/Usuario/Update_Signature', 'controllerusers@updateSignature');
...
//Route::post('/notifications/', 'NotificationController');
  ...
  //////rutas de Plan de Evaluacion/////////////
	...
	Route::post('/QrGenerador', 'controllerusers@qrGenerador');
	Route::post('/ScanQr', 'controllerusers@scanQr');
	Route::get('/ScanTest', 'controllerusers@ScanTest');
...
//Mineria
	Route::get('/Mineria', 'controllermineria@mineria');
